                ...
                <tbody>
                    @foreach($ebillings as $key => $ebilling)
                        <tr data-entry-id="{{ $ebilling->id }}">
                            ...
                            <td>
                                @can('ebilling_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.ebillings.show', $ebilling->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan

                                @can('ebilling_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.ebillings.edit', $ebilling->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan

                                @can('ebilling_delete')
                                    <form action="{{ route('admin.ebillings.destroy', $ebilling->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@endcan
  ...
  let table = $('.datatable-Ebilling:not(.ajaxTable)').DataTable({ buttons: dtButtons })
