                ...
                <form method="POST" action="{{ route('admin.merchants.update', [$merchant->id]) }}"
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name"
                            id="name" value="{{ old('name', $merchant->name) }}">
                        @if ($errors->has('name'))
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" type="text"
                            name="description" id="description" value="{{ old('description', $merchant->description) }}">
                    ...
                    {{-- <div class="form-group">
                        ...
                        <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status"
                            ...
                            @foreach (App\Models\Merchant::STATUS_SELECT as $key => $label)
                                <option value="{{ $key }}"
                                    {{ old('status', $merchant->status) === (string) $key ? 'selected' : '' }}>
                                    {{ $label }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        <label for="delivery_fee">{{ trans('cruds.merchant.fields.delivery_fee') }}</label>
                        <input class="form-control {{ $errors->has('delivery_fee') ? 'is-invalid' : '' }}" type="text"
                            name="delivery_fee" id="delivery_fee" value="{{ old('delivery_fee', $merchant->delivery_fee) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" type="text"
                            name="address" id="address" value="{{ old('address', $merchant->address) }}">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2 {{ $errors->has('state') ? 'is-invalid' : '' }}"
                            ...
                            @foreach ($states as $id => $entry)
                                <option value="{{ $id }}"
                                    {{ (old('state_id') ? old('state_id') : $merchant->state->id ?? '') == $id ? 'selected' : '' }}>
                                    {{ $entry }}</option>
                            @endforeach
                        </select>
                        @if ($errors->has('state'))
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('longitude') ? 'is-invalid' : '' }}" type="text"
                            name="longitude" id="longitude" value="{{ old('longitude', $merchant->longitude) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('latitude') ? 'is-invalid' : '' }}" type="text"
                            name="latitude" id="latitude" value="{{ old('latitude', $merchant->latitude) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('ssm_number') ? 'is-invalid' : '' }}" type="text"
                            name="ssm_number" id="ssm_number" value="{{ old('ssm_number', $merchant->ssm_number) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('ssm_document') ? 'is-invalid' : '' }}" type="file"
                            name="ssm_document" id="ssm_document" value="{{ old('ssm_document', $merchant->ssm_document) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('logo') ? 'is-invalid' : '' }}" type="file"
                            name="logo" id="logo" value="{{ old('logo', $merchant->logo) }}">
                        @if ($errors->has('logo'))
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2 {{ $errors->has('categories') ? 'is-invalid' : '' }}"
                            ...
                            @foreach ($categories as $id => $category)
                                <option value="{{ $id }}"
                                    {{ in_array($id, old('categories', [])) || $merchant->categories->contains($id) ? 'selected' : '' }}>
                                    {{ $category }}</option>
                            @endforeach
                        </select>
