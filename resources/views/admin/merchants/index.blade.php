                ...
                <tbody>
                    @foreach($merchants as $key => $merchant)
                        <tr data-entry-id="{{ $merchant->id }}">
                            ...
                            <td>
                                @can('merchant_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.merchants.show', $merchant->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan

                                @can('merchant_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.merchants.edit', $merchant->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan

                                @can('merchant_delete')
                                    <form action="{{ route('admin.merchants.destroy', $merchant->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
