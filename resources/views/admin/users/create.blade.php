        ...
        <form method="POST" action="{{ route("admin.users.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('verify') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="verify" id="verify" value="1" {{ old('verify', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('verify_token') ? 'is-invalid' : '' }}" type="text" name="verify_token" id="verify_token" value="{{ old('verify_token', '') }}">
